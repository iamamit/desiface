            ...
            <div className="flex items-center gap-1">
              ...
              {isOwner && (
                <div ref={menuRef} className="relative">
                  <button data-testid="post-menu-btn" onClick={() => setShowMenu((v) => !v)} className="p-1.5 rounded-full text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 hover:bg-gray-100 dark:hover:bg-[#2E2E2E] transition-colors">
                  ...
                  {showMenu && (
                    <div className="absolute right-0 top-7 w-36 bg-white dark:bg-[#242424] rounded-lg shadow-xl border border-gray-200 dark:border-[#3E3E3E] z-10 overflow-hidden">
                      ...
                      <button data-testid="delete-post-btn" onClick={deletePost}
